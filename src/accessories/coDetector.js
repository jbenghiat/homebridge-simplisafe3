class SS3CODetector {
    ...
    async refreshState() {
        ...
        try {
            ...
            let homekitTriggeredState = triggered ? this.Characteristic.CarbonMonoxideDetected.CO_LEVELS_ABNORMAL : this.Characteristic.CarbonMonoxideDetected.CO_LEVELS_NORMAL;
